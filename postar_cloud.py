# -*- coding: utf-8 -*-
"""
GFOOD - Robo de postagem na NUVEM (GitHub Actions, cron 12h BRT).
...
SITE_URL = "https://leobontorin.github.io/gfood-insta-media"
...
def main():
    ...
    nome = f"gf_{datetime.now(BRT):%Y%m%d}.jpg"
